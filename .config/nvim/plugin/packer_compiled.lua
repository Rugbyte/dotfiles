...
_G.packer_plugins = {
  ...
  ["emmet-vim"] = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/emmet-vim",
  ...
  ["nvim-ts-autotag"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/simon/.local/share/nvim/site/pack/packer/opt/nvim-ts-autotag",
  ...
  ["vim-ReplaceWithRegister"] = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/vim-ReplaceWithRegister",
